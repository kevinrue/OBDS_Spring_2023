...
mkdir 4_outputs/hisat2
hisat2 \
  -x /databank/igenomes/Mus_musculus/Ensembl/GRCm38/Sequence/HISAT2/genome \
  --rna-strandness RF \
  --threads 12 \
  --read-lengths 43,42,41,40,39,38,35 \
  -1 1_fastq/ERR1755082_1.fastq.gz \
  -2 1_fastq/ERR1755082_2.fastq.gz \
  -S 4_outputs/hisat2/ERR1755082.sam \
  --summary-file 4_outputs/hisat2/ERR1755082.log
