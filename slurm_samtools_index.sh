...
mkdir 4_outputs/samtools
samtools view -b -h --threads 12 4_outputs/hisat2/ERR1755082.sam |
  samtools sort --threads 12 -o 4_outputs/samtools/ERR1755082.sorted.bam -
samtools index -@ 12 4_outputs/samtools/ERR1755082.sorted.bam
