...
mkdir 4_outputs/fastqc
fastqc --nogroup --threads 1 --extract -o 4_outputs/fastqc 1_fastq/ERR1755082_1.fastq.gz
fastqc --nogroup --threads 1 --extract -o 4_outputs/fastqc 1_fastq/ERR1755082_2.fastq.gz
