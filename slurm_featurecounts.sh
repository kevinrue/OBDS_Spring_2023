...
mkdir 4_outputs/featureCounts
gunzip -c 2_genome/Mus_musculus.GRCm39.107.gtf.gz > 2_genome/Mus_musculus.GRCm39.107.gtf
featureCounts \
  -a 2_genome/Mus_musculus.GRCm39.107.gtf \
  -t exon \
  -g gene_id \
  -o 4_outputs/featureCounts/counts.tsv \
  -s 2 \
  -p \
  -B -C \
  -T 12 \
  4_outputs/samtools/ERR1755082.sorted.bam
